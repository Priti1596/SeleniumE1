...
public class ContextClickMethod {
	...
	public static void main(String[] args) {
		...
		Actions act = new Actions(driver);//To create an object of an action class
...
act.click(rightClickLink).perform();// To perform single click operation using click method of Action class 

 WebElement button1 = driver.findElement(By.xpath("//button[@id = 'btn30']"));
act.contextClick(button1).perform();// To perform right click operation on WebElement method of Action class 
 WebElement button1Option = driver.findElement(By.xpath("//div[text()='Yes']"));
act.click(button1Option).perform();// To perform single click operation using click method of Action class 


WebElement button2 = driver.findElement(By.xpath("//button[@id = 'btn31']"));
act.contextClick(button2).perform();// To perform right click operation on WebElement 
